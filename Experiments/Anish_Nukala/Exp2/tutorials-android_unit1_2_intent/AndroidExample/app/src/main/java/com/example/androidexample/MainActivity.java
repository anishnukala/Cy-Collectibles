...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            finishBtn.setVisibility(View.GONE);   // home screen: no finish button
        } else {
            String number = extras.getString("NUM");
            messageText.setText("The number was " + number);
            finishBtn.setVisibility(View.VISIBLE); // back-to-main menu: show finish
        }

        finishBtn.setOnClickListener(v -> finishAffinity()); // closes the app
